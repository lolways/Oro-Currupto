...
import net.mcreator.orocorrupto.world.features.ores.NucleoOreFeature;
...
public class OroCorruptoModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(NucleoOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, NucleoOreFeature.GENERATE_BIOMES,
				NucleoOreFeature.CONFIGURED_FEATURE));
	}
